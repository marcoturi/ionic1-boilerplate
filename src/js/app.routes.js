    ...
    angular.module('app')
        ...
        .config(($stateProvider, $urlRouterProvider) => {
            ...
            $urlRouterProvider.otherwise(($injector, $location) => {
                ...
                // Questo comporta problemi nel login automatico all'avvio dell'app, portando sempre alla pagina di login
                const unmanagedUrl = $location.absUrl();
                console.log('Unmanaged Url. Fallback in $urlRouterProvider.otherwise : ' + unmanagedUrl);
